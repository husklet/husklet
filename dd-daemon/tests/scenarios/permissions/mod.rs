    ...
    sgroup(
        ...
        vec![
            ...
            scen("permissions/dev-null-majmin", "alpine:latest")
                .exec("ls -l /dev/null | awk '{print $5, $6}'")
                .has("1, 3"),
            scen("permissions/dev-zero-majmin", "alpine:latest")
                .exec("ls -l /dev/zero | awk '{print $5, $6}'")
                .has("1, 5"),
            scen("permissions/dev-full-majmin", "alpine:latest")
                .exec("ls -l /dev/full | awk '{print $5, $6}'")
                .has("1, 7"),
            ...
            scen("permissions/root-reads-0000", "alpine:latest")
                .exec("touch /f && chmod 000 /f && cat /f >/dev/null 2>&1 && echo ROOT_READ_OK")
                .has("ROOT_READ_OK"),
            ...
            scen("permissions/nonexec-test-x", "alpine:latest")
                .exec("touch /f && chmod 644 /f && { test -x /f && echo X || echo NOX; }")
                .has("NOX"),
