...
fn ext_stdio() -> Group {
    group(
        ...
        vec![
            ...
            port("sscanf-num", "ext_libc/sscanf_num.c")
                .out("sscanf_num d1=1 d2=1 d3=1 d4=1 d5=1 d6=1\n"),
            port("sscanf-str", "ext_libc/sscanf_str.c")
                .out("sscanf_str d1=1 d2=1 d3=1 d4=1 d5=1\n"),
            port("sscanf-mix", "ext_libc/sscanf_mix.c")
                .out("sscanf_mix d1=1 d2=1 d3=1 d4=1 d5=1\n"),
            port("fread-fwrite", "ext_libc/fread_fwrite.c")
                .out("fread_fwrite d1=1 d2=1 d3=1 d4=1\n"),
            port("fseek-ftell", "ext_libc/fseek_ftell.c")
                .out("fseek_ftell d1=1 d2=1 d3=1 d4=1 d5=1\n"),
            port("ungetc", "ext_libc/ungetc.c").out("ungetc d1=1 d2=1 d3=1 d4=1 d5=1 d6=1\n"),
            port("fgets-fputs", "ext_libc/fgets_fputs.c")
                .out("fgets_fputs d1=1 d2=1 d3=1 d4=1 d5=1\n"),
...
fn ext_math() -> Group {
    group(
        ...
        vec![
            ...
            port("math-mod", "ext_libc/math_mod.c")
                .out("math_mod d1=1 d2=1 d3=1 d4=1 d5=1 d6=1 d7=1\n"),
            port("math-frexp", "ext_libc/math_frexp.c")
                .out("math_frexp d1=1 d2=1 d3=1 d4=1 d5=1 d6=1 d7=1\n"),
            port("math-misc", "ext_libc/math_misc.c")
                .out("math_misc d1=1 d2=1 d3=1 d4=1 d5=1 d6=1 d7=1\n"),
...
fn ext_ctype_wchar() -> Group {
    group(
        "ext-ctype-wchar",
        vec![
            port("ctype-class", "ext_libc/ctype_class.c").out(
                "ctype_class d1=1 d2=1 d3=1 d4=1 d5=1 d6=1 d7=1 d8=1 d9=1 d10=1 d11=1 d12=1\n",
            ),
