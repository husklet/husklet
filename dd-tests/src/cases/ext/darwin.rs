...
pub fn groups() -> Vec<Group> {
    vec![
        ...
        group(
            "darwin-sysctl",
            vec![
                darwin_libc("sysctl-memsize", "darwin/sysctl_memsize.c")
                    .out("sysctl mem_ok=1 page_ok=1\n"),
                darwin_libc("sysctl-mib", "darwin/sysctl_mib.c")
                    .out("sysctl mib ostype=Darwin ok=1\n"),
                darwin_libc("sysctl-kernproc", "darwin/sysctl_kernproc.c")
                    .out("sysctl kern_proc pid_match=1\n"),
            ],
        ),
        ...
        group(
            ...
            vec![
                ...
                darwin_libc("pthread-mutex", "darwin/pthread_mutex.c")
                    .out("pthread mutex counter=40000\n"),
        ...
        group(
            ...
            vec![
                ...
                darwin_libc("dispatch-async", "darwin/dispatch_async.c")
                    .out("dispatch async x=42\n"),
                darwin_libc("dispatch-group", "darwin/dispatch_group.c")
                    .out("dispatch group sum=55\n"),
                darwin_libc("dispatch-apply", "darwin/dispatch_apply.c")
                    .out("dispatch apply sum=4950\n"),
                darwin_libc("dispatch-once", "darwin/dispatch_once.c")
                    .out("dispatch once count=1\n"),
        ...
        group(
            ...
            vec![
                ...
                darwin_libc("macho-data", "darwin/macho_data.c")
                    .out("data sum=100 bss=0 str=DATAOK\n"),
                ...
                darwin_libc("macho-stub", "darwin/macho_stub.c")
                    .out("stub len=5 snp=6 buf=42-xyz\n"),
        ...
        group(
            ...
            vec![
                ...
                darwin_libc("bsd-getattrlist", "darwin/bsd_getattrlist.c")
                    .out("getattrlist ok=1\n"),
                ...
                darwin_libc("bsd-gettimeofday", "darwin/bsd_gettimeofday.c")
                    .out("gettimeofday mono=1\n"),
        ...
        group(
            "darwin-wx",
            vec![darwin_libc("mmap-jit", "darwin/mmap_jit.c").out("jit ret=42\n")],
        ),
    ]
}
