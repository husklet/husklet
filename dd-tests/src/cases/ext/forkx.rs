//! forkx — fork-path stress (task #371, preserved-arena fork). Owner: fork-cost agent. Edit ONLY this file.
//! Keep this module compiling at all times (`cargo build -p dd-tests`).
//!
//! The #371 change makes a fork child KEEP the parent's dual-mapped code cache (RX re-remapped from the
