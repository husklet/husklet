...
pub fn scenarios() -> Vec<Scenario> {
    vec![
        ...
        scen(
            "languages/python-bigint-repl-312-alpine",
            "python:3.12-alpine",
        )
