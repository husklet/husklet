...
HL_CPU_ASSERT(hl_native_aarch64_cpu, active_authority, 1872);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_valid, 1880);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_view_count, 1888);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_views, 1896);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_mapping_incarnation, 1992);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_authority, 2000);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_trip, 2008);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_decrement, 2016);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_instruction_count, 2024);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_iterations, 2032);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_budget_iterations, 2040);
HL_CPU_ASSERT(hl_native_aarch64_cpu, loop_executable, 2048);
HL_CPU_ASSERT(hl_native_aarch64_cpu, active_view_incarnation, 2056);
HL_CPU_ASSERT(hl_native_aarch64_cpu, active_view_authority, 2064);
HL_CPU_ASSERT(hl_native_aarch64_cpu, diagnostic_guard_fast, 2072);
HL_CPU_ASSERT(hl_native_aarch64_cpu, diagnostic_guard_full, 2080);
HL_CPU_ASSERT(hl_native_aarch64_cpu, diagnostic_guard_fallback, 2088);
HL_CPU_ASSERT(hl_native_aarch64_cpu, diagnostic_dirty_reserved, 2096);
HL_CPU_ASSERT(hl_native_aarch64_cpu, diagnostic_dirty_overflow, 2104);
HL_CPU_ASSERT(hl_native_aarch64_cpu, diagnostic_dirty_committed, 2112);
HL_CPU_ASSERT(hl_native_aarch64_cpu, diagnostic_dirty_merged, 2120);
HL_CPU_ASSERT(hl_native_aarch64_cpu, read_view_publication, 2128);
HL_CPU_ASSERT(hl_native_aarch64_cpu, memory_write_policy, 2192);
HL_CPU_ASSERT(hl_native_aarch64_cpu, memory_write_index, 2200);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_guest_first, 2208);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_guest_last, 2216);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_host_first, 2224);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_data_permissions, 2232);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_mapped_executable, 2240);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_mapping_incarnation, 2248);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_mapping_generation, 2256);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_instruction_generation, 2264);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_authority_identity, 2272);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_authority_generation, 2280);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_run_generation, 2288);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_view_index, 2296);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_write_policy, 2304);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_cache_identity, 2312);
HL_CPU_ASSERT(hl_native_aarch64_cpu, certificate_token, 2320);
HL_CPU_ASSERT(hl_native_aarch64_cpu, diagnostic_ibtc_authenticated_entries,
              2328);
HL_CPU_ASSERT(hl_native_aarch64_cpu, diagnostic_ibtc_shared_hits, 2336);
HL_CPU_ASSERT(hl_native_aarch64_cpu, diagnostic_ibtc_auth_rejections, 2344);
HL_CPU_ASSERT(hl_native_aarch64_cpu, code_arena_lower, 2352);
HL_CPU_ASSERT(hl_native_aarch64_cpu, code_arena_upper, 2360);
HL_CPU_ASSERT(hl_native_aarch64_cpu, entry_certificate_identity, 2368);
...
HL_CPU_ASSERT(hl_native_aarch64_cpu, reserve_filter, 2408);
_Static_assert(sizeof(hl_native_aarch64_cpu) == 2472,
               "aarch64 native CPU prefix size drifted");

_Static_assert(_Alignof(hl_native_aarch64_cpu) == 8,
               "aarch64 native CPU prefix alignment drifted");
...
_Static_assert(sizeof(hl_native_x86_64_cpu) == 2008,
               "x86_64 native CPU prefix size drifted");

_Static_assert(_Alignof(hl_native_x86_64_cpu) == 8,
               "x86_64 native CPU prefix alignment drifted");
