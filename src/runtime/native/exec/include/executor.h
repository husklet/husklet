...
typedef struct hl_native_memory {
  ...
  uint32_t size;
  void *context;
  hl_native_status (*reserve)(void *, uint64_t, uint64_t, uint32_t,
                              hl_native_mapping *);
...
typedef uint32_t (*hl_native_operand_resolve)(
    void *context, uint64_t address, uint64_t size, uint32_t access,
    uint64_t mapping_incarnation, uint64_t instruction_epoch,
...
typedef uint32_t (*hl_native_fault_publish)(void *,
                                            const hl_native_fault_scope *);
typedef void (*hl_native_fault_unpublish)(void *,
                                          const hl_native_fault_scope *);
...
_Static_assert(UINTPTR_MAX == UINT64_MAX,
               "native execution requires a 64-bit host ABI");
...
_Static_assert(offsetof(hl_native_diagnostics, a64_fallback_entry_rejection) ==
                   384,
...
_Static_assert(offsetof(hl_native_diagnostics, ibtc_authenticated_entries) ==
                   520,
               "native diagnostics append offset drifted");
_Static_assert(sizeof(hl_native_diagnostics) == 608,
               "native diagnostics ABI drifted");
...
_Static_assert(offsetof(hl_native_address, constant) == 8,
               "native address constant offset drifted");
_Static_assert(offsetof(hl_native_address, kind) == 16,
               "native address shape offset drifted");
_Static_assert(sizeof(hl_native_provenance) == 56,
               "native provenance ABI drifted");
_Static_assert(offsetof(hl_native_provenance, address) == 24,
               "native provenance address offset drifted");
_Static_assert(offsetof(hl_native_provenance, access) == 48,
               "native provenance access offset drifted");
_Static_assert(sizeof(hl_native_exit) == 48, "native exit ABI drifted");
_Static_assert(sizeof(hl_native_source_span) == 40,
               "native source span ABI drifted");
_Static_assert(sizeof(hl_native_source) == 32, "native source ABI drifted");
_Static_assert(sizeof(hl_native_projection_view) == 40,
               "native projection view ABI drifted");
_Static_assert(sizeof(hl_native_projection) == 32,
               "native projection ABI drifted");
_Static_assert(offsetof(hl_native_run_request, source) == 32,
               "native run prefix ABI drifted");
_Static_assert(offsetof(hl_native_run_request, operand_context) == 64,
               "native resolver prefix ABI drifted");
_Static_assert(sizeof(hl_native_run_certificate) == 112,
               "native run certificate ABI drifted");
...
_Static_assert(sizeof(hl_native_run_request) == 168,
               "native run request ABI drifted");
_Static_assert(sizeof(hl_native_cpu) == 24, "native CPU handle ABI drifted");
_Static_assert(sizeof(hl_native_fault_scope) == 32,
               "native fault scope ABI drifted");
_Static_assert(sizeof(hl_native_direct_authority) == 64,
               "native direct authority ABI drifted");
...
hl_native_status hl_native_create(const hl_native_config *,
                                  hl_native_executor **);
...
hl_native_status hl_native_diagnose(const hl_native_executor *,
                                    hl_native_diagnostics *);
...
hl_native_status hl_native_resolve_fault(const hl_native_executor *,
                                         hl_native_fault *);
hl_native_status hl_native_fault_scope_enter(hl_native_executor *,
                                             hl_native_cpu *,
...
int hl_native_fault_scope_provenance(const hl_native_fault_scope *, uint64_t,
                                     hl_native_provenance *);
int hl_native_fault_scope_prepare_return(const hl_native_fault_scope *,
...
hl_native_status hl_native_fault_thread_publish(const hl_native_fault_scope *,
                                                uint64_t *);
hl_native_status hl_native_fault_thread_unpublish(const hl_native_fault_scope *,
                                                  uint64_t);
...
int hl_native_direct_validate(const hl_native_executor *,
                              const hl_native_direct_token *,
                              hl_native_direct_authority *);
uint64_t hl_native_direct_generation(const hl_native_executor *,
                                     const hl_native_direct_token *);
uint64_t hl_native_direct_identity(const hl_native_executor *,
                                   const hl_native_direct_token *);
hl_native_status hl_native_direct_unregister(hl_native_executor *,
                                             hl_native_direct_token *);
