...
hl_native_status hl_native_cache_create(hl_native_cache **, hl_native_arena *,
                                        uint32_t, uint32_t, uint32_t, uint64_t,
                                        const hl_native_cache_observer *);
hl_native_lookup hl_native_cache_lookup(hl_native_cache *, uint64_t, uint64_t,
                                        hl_native_code *);
hl_native_lookup hl_native_cache_lookup_key(hl_native_cache *, uint64_t,
                                            uint64_t, uint64_t, uint64_t,
                                            uint64_t, hl_native_code *);
...
hl_native_lookup hl_native_cache_probe_key(hl_native_cache *, uint64_t,
                                           uint64_t, uint64_t, uint64_t,
                                           uint64_t, hl_native_code *);
hl_native_lookup hl_native_cache_probe_key_counted(
    hl_native_cache *, hl_native_cache_lookup_counts *, uint64_t, uint64_t,
    uint64_t, uint64_t, uint64_t, hl_native_code *);
...
hl_native_status hl_native_cache_reserve(hl_native_cache *, uint64_t, uint64_t,
                                         uint64_t, uint64_t, uint64_t,
                                         hl_native_block *);
hl_native_status
hl_native_cache_reserve_key(hl_native_cache *, uint64_t, uint64_t, uint64_t,
                            uint64_t, uint64_t, uint64_t, uint64_t, uint64_t,
                            const hl_native_certificate_record *,
                            hl_native_block *);
hl_native_status hl_native_cache_writable(hl_native_cache *,
                                          const hl_native_block *, void **,
                                          uint64_t *);
hl_native_status hl_native_cache_publish(hl_native_cache *, hl_native_block *,
                                         uint64_t, uint64_t);
hl_native_status
hl_native_cache_publish_map(hl_native_cache *, hl_native_block *, uint64_t,
                            uint64_t, const hl_native_provenance *, uint32_t);
...
hl_native_status hl_native_cache_relocate(hl_native_cache *, uint64_t, uint64_t,
                                          const hl_native_relocation *,
                                          uint32_t);
hl_native_status hl_native_cache_relocate_site(hl_native_cache *, const void *,
...
int hl_native_cache_certificate(const hl_native_cache *, uint64_t,
                                hl_native_certificate_record *);
void hl_native_cache_fail(hl_native_cache *);
hl_native_status hl_native_cache_relocations_invalidate(hl_native_cache *,
                                                        uint64_t, uint64_t);
hl_native_status hl_native_cache_reset(hl_native_cache *, uint64_t);
hl_native_status hl_native_cache_reset_epoch(hl_native_cache *, uint64_t,
                                             uint64_t);
hl_native_status hl_native_cache_reset_identity(hl_native_cache *, uint64_t,
                                                uint64_t, uint64_t, uint64_t);
...
int hl_native_cache_address_identity_matches(const hl_native_cache *, uint64_t,
                                             uint64_t, uint64_t);
int hl_native_cache_execution(const hl_native_cache *, uint64_t,
                              hl_native_code *);
hl_native_status hl_native_cache_invalidate(hl_native_cache *, uint64_t,
                                            uint64_t, uint32_t *);
int hl_native_cache_provenance(const hl_native_cache *, const void *,
                               uint64_t *);
int hl_native_cache_provenance_record(const hl_native_cache *, const void *,
                                      hl_native_provenance *);
int hl_native_address_reconstruct(const hl_native_address *, const uint64_t *,
                                  uint32_t, uint64_t *);
