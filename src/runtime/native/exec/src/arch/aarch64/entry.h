...
_Static_assert(offsetof(hl_native_aarch64_cpu, read_token) == 1688, "aarch64 view-table proof drifted");
_Static_assert(offsetof(hl_native_aarch64_cpu, read_incarnation) == 1696, "aarch64 view-table proof drifted");
_Static_assert(offsetof(hl_native_aarch64_cpu, read_count) == 1704, "aarch64 view-table proof drifted");
_Static_assert(offsetof(hl_native_aarch64_cpu, read_valid_count) == 2400, "aarch64 view-table proof drifted");
