...
int hl_a64_trace_loop_plan(const uint32_t *, size_t, uint64_t,
                           hl_a64_loop_plan *);
hl_a64_loop_preflight_status
hl_a64_trace_loop_preflight(const hl_native_aarch64_cpu *,
                            const hl_a64_loop_plan *, uint64_t, uint64_t,
                            uint64_t, hl_a64_loop_entry *);
...
int hl_a64_trace_range_plan(const uint32_t *, size_t, uint64_t,
                            hl_a64_range_plan *);

int hl_a64_trace_certificate_check(const hl_native_aarch64_cpu *, uint64_t,
                                   int64_t, int64_t, uint32_t, uint64_t,
                                   uint64_t, uint64_t, uint64_t *);

int hl_a64_trace_build(const hl_a64_source *, uint64_t, size_t, void *, size_t,
                       hl_a64_trace_result *);
int hl_a64_trace_build_density(const hl_a64_source *, uint64_t, size_t, void *,
                               size_t, hl_a64_trace_result *,
                               hl_a64_trace_density *);
...
int hl_a64_trace_build_direct(const hl_a64_source *, uint64_t, size_t, void *,
                              size_t, const hl_native_direct_authority *,
                              uint64_t, hl_a64_trace_result *);
hl_native_status hl_a64_trace_cache(hl_native_executor *, const hl_a64_source *,
                                    uint64_t, size_t, void *, size_t,
                                    hl_native_code *, uint32_t *);
hl_native_status hl_a64_trace_cache_direct(hl_native_executor *,
                                           const hl_a64_source *, uint64_t,
                                           size_t, void *, size_t,
