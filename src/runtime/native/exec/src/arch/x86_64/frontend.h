...
/* Every accepted flag bit. A new capability flag belongs here as well, or every
 * request carrying it is rejected; `hl_x86_a64_unknown_flags` names the
 * offending bits when that is forgotten. */
#define HL_X86_A64_FLAGS                                                       \
  (HL_X86_A64_CHECKPOINTS | HL_X86_A64_CONDITIONAL_SELF_LOOP |                 \
   HL_X86_A64_LIVE_CHAIN | HL_X86_A64_LSE | HL_X86_A64_DIAGNOSTICS |           \
   HL_X86_A64_AES)
...
hl_x86_a64_status hl_x86_a64_emit(const hl_x86_a64_request *,
                                  hl_x86_a64_result *);

/* Returns the request flag bits this build does not recognise, so a rejected
 * request can name them instead of reading as a decoder fault. */
