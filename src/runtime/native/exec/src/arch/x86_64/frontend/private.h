...
void hl_x86_emit_bitscan(uint32_t *words, uint32_t *cursor,
                         const instruction *item);
int hl_x86_decode_bit(const hl_x86_a64_request *request, decode *block,
                      instruction *item, uint8_t opcode, uint8_t rex,
                      uint8_t operand_16, uint8_t address_32, size_t start,
                      size_t *cursor);
uint32_t hl_x86_bit_words(const instruction *item);
void hl_x86_emit_bit(uint32_t *words, uint32_t *cursor,
                     const instruction *item);
uint32_t hl_x86_string_words(const instruction *item);
void hl_x86_emit_string(uint32_t *words, uint32_t *cursor,
                        const instruction *item);
uint32_t hl_x86_bit(unsigned destination, unsigned source, unsigned lsb);
void hl_x86_emit_alu(uint32_t *words, uint32_t *cursor,
                     const instruction *item);
uint32_t hl_x86_accumulator_words(const instruction *item);
void hl_x86_emit_accumulator(uint32_t *words, uint32_t *cursor,
                             const instruction *item);
int hl_x86_decode_imul(const hl_x86_a64_request *request, decode *block,
                       instruction *item, uint8_t opcode, uint8_t rex,
                       uint8_t operand_16, uint8_t address_32, size_t start,
                       size_t *cursor);
uint32_t hl_x86_imul_words(const instruction *item);
void hl_x86_emit_imul(uint32_t *words, uint32_t *cursor,
                      const instruction *item);
int hl_x86_decode_mul(const hl_x86_a64_request *request, decode *block,
                      instruction *item, uint8_t opcode, uint8_t rex,
                      uint8_t operand_16, uint8_t address_32, size_t start,
                      size_t *cursor);
uint32_t hl_x86_mul_words(const instruction *item);
void hl_x86_emit_mul(uint32_t *words, uint32_t *cursor,
                     const instruction *item);
int hl_x86_decode_div(const hl_x86_a64_request *request, decode *block,
                      instruction *item, uint8_t opcode, uint8_t rex,
                      uint8_t operand_16, uint8_t address_32, size_t start,
                      size_t *cursor);
uint32_t hl_x86_div_words(const instruction *item);
void hl_x86_emit_div(uint32_t *words, uint32_t *cursor,
                     const instruction *item);
...
int hl_x86_request_valid(const hl_x86_a64_request *request,
                         const hl_x86_a64_result *result);
hl_x86_a64_status hl_x86_result(const hl_x86_a64_request *request,
                                const decode *block, hl_x86_a64_result *result,
                                uint32_t words);
...
int hl_x86_decode_immediate(const hl_x86_a64_request *request, decode *block,
                            instruction *item, uint8_t opcode, uint8_t rex,
                            uint8_t operand_16, uint8_t address_32,
                            size_t start, size_t *cursor);
int hl_x86_test_opcode(uint8_t opcode);
int hl_x86_decode_test(const hl_x86_a64_request *request, decode *block,
                       instruction *item, uint8_t opcode, uint8_t rex,
                       uint8_t operand_16, uint8_t address_32, uint8_t lock,
                       size_t start, size_t *cursor);
int hl_x86_shift_opcode(uint8_t opcode);
int hl_x86_decode_shift(const hl_x86_a64_request *request, decode *block,
                        instruction *item, uint8_t opcode, uint8_t rex,
                        uint8_t operand_16, uint8_t address_32, size_t start,
                        size_t *cursor);
uint32_t hl_x86_shift_words(const instruction *item);
void hl_x86_emit_shift(uint32_t *words, uint32_t *cursor,
                       const instruction *item);
...
void hl_x86_emit_rotate(uint32_t *words, uint32_t *cursor,
                        const instruction *item);
int hl_x86_decode_address(const hl_x86_a64_request *request, decode *block,
                          instruction *item, uint8_t rex, uint8_t operand_16,
                          uint8_t address_32, size_t start, size_t *cursor);
int hl_x86_decode_store(const hl_x86_a64_request *request, decode *block,
                        instruction *item, uint8_t opcode, uint8_t rex,
                        uint8_t operand_16, uint8_t address_32, size_t start,
                        size_t *cursor);
int hl_x86_decode_load(const hl_x86_a64_request *request, decode *block,
                       instruction *item, uint8_t opcode, uint8_t rex,
                       uint8_t operand_16, uint8_t address_32, size_t start,
                       size_t *cursor);
uint32_t hl_x86_address_words(const instruction *item);
void hl_x86_emit_address(uint32_t *words, uint32_t *cursor,
                         const instruction *item);
...
void hl_x86_emit_cmov(uint32_t *words, uint32_t *cursor,
                      const instruction *item, unsigned source);
uint32_t hl_x86_set_words(const instruction *item);
void hl_x86_emit_set(uint32_t *words, uint32_t *cursor,
                     const instruction *item);
...
void hl_x86_emit_control(uint32_t *words, uint32_t *cursor,
                         const instruction *item);
