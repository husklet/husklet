...
struct hl_native_executor {
  ...
  uint64_t boundary_branch, boundary_syscall, boundary_fallback, boundary_yield,
      completed;
  ...
  _Atomic uint64_t relocation_cold_targets, relocation_cycles,
      relocation_capacity;
  _Atomic uint64_t relocation_invalidations, ibtc_site_misses,
      ibtc_shared_misses;
  ...
  _Atomic uint64_t a64_fallback_call, a64_fallback_return,
      a64_fallback_indirect;
  _Atomic uint64_t a64_fallback_system, a64_fallback_form_memory,
      a64_fallback_form_other;
...
hl_native_status hl_native_execution_enter(hl_native_executor *,
                                           hl_native_execution *);
uint64_t hl_native_execution_generation(const hl_native_execution *);
hl_native_status hl_native_execution_bind_certificate(hl_native_execution *,
                                                      uint64_t *);
hl_native_status hl_native_execution_leave(hl_native_execution *);
hl_native_status hl_native_execution_exit(hl_native_execution *,
                                          hl_native_exit *, uint32_t, uint32_t,
                                          uint64_t, uint64_t, uint64_t,
                                          uint64_t);
hl_native_status hl_native_synchronize_epoch(hl_native_executor *, uint64_t,
                                             uint64_t, uint64_t, uint64_t);
hl_native_status hl_native_synchronize_direct(hl_native_executor *, uint64_t,
                                              uint64_t,
                                              const hl_native_direct_token *,
                                              uint64_t, uint64_t,
                                              const hl_native_projection *);
hl_native_status hl_native_executor_rollover(hl_native_executor *, uint64_t,
                                             uint64_t);
void hl_native_ibtc_fill_shared(hl_native_executor *, uint64_t, void *);
#if defined(__aarch64__)
hl_native_status hl_native_ibtc_fill(hl_native_executor *,
                                     hl_native_aarch64_cpu *, uint64_t,
                                     const hl_native_code *);
#endif
int hl_native_direct_request_valid(const hl_native_executor *,
                                   const hl_native_direct_token *, uint64_t,
                                   uint64_t, const hl_native_projection *);
int hl_native_direct_request_snapshot(const hl_native_executor *,
                                      const hl_native_direct_token *, uint64_t,
                                      uint64_t, const hl_native_projection *,
...
void hl_a64_run_view_publish(const hl_a64_run_views *, hl_native_aarch64_cpu *,
                             uint64_t);
#endif
