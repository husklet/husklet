...
hl_native_status hl_native_arena_create(hl_native_arena *,
                                        const hl_native_config *);
hl_native_status hl_native_arena_begin(hl_native_arena *);
hl_native_status hl_native_arena_allocate(hl_native_arena *, uint64_t, uint64_t,
                                          hl_native_span *);
hl_native_status hl_native_arena_publish(hl_native_arena *,
                                         const hl_native_span *, uint64_t);
