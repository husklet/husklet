...
#define hl_target_backend_tree_shared_size HL_TARGET_LOCAL(target_backend_tree_shared_size)
#define hl_target_backend_tree_child_begin HL_TARGET_LOCAL(target_backend_tree_child_begin)
#define hl_target_backend_tree_reap_report HL_TARGET_LOCAL(target_backend_tree_reap_report)
...
#define hl_engine_child_result_begin_for_test HL_TARGET_LOCAL(engine_child_result_begin_for_test)
#define hl_engine_child_result_end_for_test HL_TARGET_LOCAL(engine_child_result_end_for_test)
...
#define hl_checkpoint_restore_fd_reset_test HL_TARGET_LOCAL(checkpoint_restore_fd_reset_test)
...
#define jit_guest_bus_reset_after_rewind HL_TARGET_LOCAL(jit_guest_bus_reset_after_rewind)
