...
// A syscall is about to re-execute at the same instruction: put back the registers normalization consumed.
#define G_RESTART_PRESERVE(c) hl_x86_legacy_restore_restart(c)
