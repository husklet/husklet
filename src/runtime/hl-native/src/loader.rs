...
pub(crate) struct TestApi {
    ...
    pub(crate) aarch64_ofd_identity: ScenarioTest,
    pub(crate) x86_64_ofd_identity: ScenarioTest,
    pub(crate) aarch64_checkpoint_pipe_schema: ScenarioTest,
    pub(crate) x86_64_checkpoint_pipe_schema: ScenarioTest,
...
fn load_tests(library: &DynamicLibrary, path: &Path) -> Result<TestApi, LoadError> {
    ...
    Ok(TestApi {
        ...
        aarch64_ofd_identity: symbol!("hl_aarch64_ofd_identity_test", ScenarioTest),
        x86_64_ofd_identity: symbol!("hl_x86_64_ofd_identity_test", ScenarioTest),
        aarch64_checkpoint_pipe_schema: symbol!("hl_aarch64_checkpoint_pipe_schema_test", ScenarioTest),
        x86_64_checkpoint_pipe_schema: symbol!("hl_x86_64_checkpoint_pipe_schema_test", ScenarioTest),
