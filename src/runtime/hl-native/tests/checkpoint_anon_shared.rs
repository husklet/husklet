...
/// Two processes derive the same identity for the region they share and, through the restore-side
/// seed for it, end up mapping ONE object: a write by one is visible to the other.
#[test]
