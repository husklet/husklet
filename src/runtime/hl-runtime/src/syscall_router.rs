...
use hl_linux::{
    ...
    NetworkSyscalls, RegisterView, SeccompSyscalls, SyscallDispatcher, SyscallDisposition, SyscallFrameDecoder,
    SyscallPorts, TaskSignalTimeSyscalls,
};
...
struct CpuRegisters<'a>(&'a mut ExecutionCpuSnapshot);
