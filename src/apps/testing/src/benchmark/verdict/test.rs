...
#[test]
fn every_crossed_cell_is_submitted_for_judgment() {
    assert_eq!(super::comparison_cells(), &[("E", "R"), ("E", "I"), ("R", "I")]);
}
...
fn evidence_provenance_must_match_the_scheduled_binary_and_layout() {
    ...
    wrong_profile.profile = crate::benchmark::definition::ProfileKind::IndependentNull;
    assert!(super::verify_row_provenance(&step, &wrong_profile).is_err());
}
