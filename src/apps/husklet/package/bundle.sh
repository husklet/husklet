...
( cd "$ROOT" && cargo build --release -p husklet --features gui --bin hl-app )
...
[ -f "$ROOT/src/apps/husklet/package/hl-app.icns" ] && cp "$ROOT/src/apps/husklet/package/hl-app.icns" "$RES/hl-app.icns" || true
