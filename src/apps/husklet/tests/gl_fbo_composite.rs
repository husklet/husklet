...
//!
//! `../../surface/hl-gl/tests/fixtures/gl_fbo_composite.c` is a header-free real GLES2 app (the EGL/GLES2 ABI is self-declared). Pass 1
...
fn real_gles2_offscreen_fbo_composited_over_the_window_on_lavapipe() {
    ...
    let compile = Command::new("gcc")
        .arg(format!(
            "{manifest}/../../surface/hl-gl/tests/fixtures/gl_fbo_composite.c"
        ))
