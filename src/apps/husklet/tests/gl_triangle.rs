...
//! readback.
//!
//! `../../surface/hl-gl/tests/fixtures/gl_triangle.c` is a header-free real GLES2 app (the EGL/GLES2 ABI is self-declared, exactly what
...
fn real_gles2_clear_and_triangle_on_lavapipe() {
    ...
    let compile = Command::new("gcc")
        .arg(format!(
            "{manifest}/../../surface/hl-gl/tests/fixtures/gl_triangle.c"
        ))
