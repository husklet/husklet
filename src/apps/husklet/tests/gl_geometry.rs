...
//!
//! `../../surface/hl-gl/tests/fixtures/gl_geometry.c` is a header-free real GLES2 app (the EGL/GLES2 ABI is self-declared, exactly what
...
//! `ShaderPayloadKind::Glsl` (two modules, vertex + fragment); `hl-gpu-wgpu` compiles it via naga's
...
fn real_gles2_triangle_rasterizes_on_lavapipe() {
    ...
    let compile = Command::new("gcc")
        .arg(format!(
            "{manifest}/../../surface/hl-gl/tests/fixtures/gl_geometry.c"
        ))
