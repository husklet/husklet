...
pub fn groups() -> Vec<Group> {
    vec![group(
        ...
        vec![
            ...
            p(
                "sc-timerfd-first-interval",
                "syscallbug/timerfd_first_interval.c",
            ),
            ...
            p(
                "sc-sigaltstack-validate",
                "syscallbug/sigaltstack_validate.c",
            ),
            // rt_sigprocmask invalid how / wrong sigsetsize -> EINVAL.
            p(
                "sc-sigprocmask-validate",
                "syscallbug/sigprocmask_validate.c",
            ),
            ...
            // Sentry close-on-exec: under HL_JIT_UNTRUSTED the guest's fds are sentry-owned VIRTUAL fds; a
