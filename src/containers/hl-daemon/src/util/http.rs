...
impl LogFrame {
    pub(crate) fn new(stream: u8, data: &[u8]) -> Vec<u8> {
...
mod tests {
    ...
    fn base64_std_rfc4648_vectors() {
        ...
        assert_eq!(Base64::encode(&[0xfb, 0xff]), "+/8=");
    }
    ...
    fn log_frame_empty_payload_is_header_only() {
        assert_eq!(LogFrame::new(1, b""), vec![1, 0, 0, 0, 0, 0, 0, 0]);
    }
}
