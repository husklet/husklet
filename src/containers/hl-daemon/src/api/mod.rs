...
pub use model::{
    ...
    HostConfig, HostInspection, ImageCommit, ImageConfig, ImageDelete, ImageHistory, ImageLoad, ImagePrune,
    ImageSummary, InspectContainer, InspectImage, LogOptions, LogProtocolError, LogStreams, Memory, MountPoint,
