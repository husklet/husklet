...
//!
//! Exercises the public headless API against the separately built daemon/client executables:
//! a scenario passes only when its behavior actually ran, never by inspecting source text.
