...
/// A spread of VEX vector kinds in memory form, each of which must produce the same
/// destination and the same YMM upper lane as the interpreter in both `L=0` and `L=1`.
#[cfg(target_arch = "aarch64")]
#[test]
fn x86_vex_memory_operand_kinds_match_interpreter_at_each_boundary() {
    let program: Vec<Vec<u8>> = vec![
        vec![0xc5, 0xf1, 0xfe, 0x06],             // vpaddd (%rsi),%xmm1,%xmm0
        vec![0xc5, 0xf5, 0xfe, 0x06],             // vpaddd (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf1, 0x60, 0x06],             // vpunpcklbw (%rsi),%xmm1,%xmm0
        vec![0xc5, 0xf5, 0x60, 0x06],             // vpunpcklbw (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf1, 0x6b, 0x06],             // vpackssdw (%rsi),%xmm1,%xmm0
        vec![0xc5, 0xf5, 0x6b, 0x06],             // vpackssdw (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf1, 0xd5, 0x06],             // vpmullw (%rsi),%xmm1,%xmm0
        vec![0xc5, 0xf1, 0xe4, 0x06],             // vpmulhuw (%rsi),%xmm1,%xmm0
        vec![0xc5, 0xf9, 0x70, 0x06, 0xe4],       // vpshufd $0xe4,(%rsi),%xmm0
        vec![0xc5, 0xfd, 0x70, 0x06, 0x1b],       // vpshufd $0x1b,(%rsi),%ymm0
        vec![0xc5, 0xf8, 0x5b, 0x06],             // vcvtdq2ps (%rsi),%xmm0
        vec![0xc5, 0xfc, 0x5b, 0x06],             // vcvtdq2ps (%rsi),%ymm0
        vec![0xc4, 0xe2, 0x79, 0x1e, 0x06],       // vpabsd (%rsi),%xmm0
        vec![0xc4, 0xe2, 0x7d, 0x1e, 0x06],       // vpabsd (%rsi),%ymm0
        vec![0xc4, 0xe2, 0x71, 0x0a, 0x06],       // vpsignd (%rsi),%xmm1,%xmm0
        vec![0xc4, 0xe2, 0x75, 0x0a, 0x06],       // vpsignd (%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x71, 0x02, 0x06],       // vphaddd (%rsi),%xmm1,%xmm0
        vec![0xc4, 0xe2, 0x71, 0x28, 0x06],       // vpmuldq (%rsi),%xmm1,%xmm0
        vec![0xc4, 0xe2, 0x75, 0x28, 0x06],       // vpmuldq (%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x71, 0x40, 0x06],       // vpmulld (%rsi),%xmm1,%xmm0
        vec![0xc4, 0xe3, 0x71, 0x0e, 0x06, 0x5a], // vpblendw $0x5a,(%rsi),%xmm1,%xmm0
        vec![0xc4, 0xe3, 0x75, 0x0e, 0x06, 0x5a], // vpblendw $0x5a,(%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xd5, 0x06],             // vpmullw (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xe4, 0x06],             // vpmulhuw (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xe5, 0x06],             // vpmulhw (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xf4, 0x06],             // vpmuludq (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xe0, 0x06],             // vpavgb (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xf6, 0x06],             // vpsadbw (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf5, 0x63, 0x06],             // vpacksswb (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf5, 0x67, 0x06],             // vpackuswb (%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf5, 0x6d, 0x06],             // vpunpckhqdq (%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x40, 0x06],       // vpmulld (%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x08, 0x06],       // vpsignb (%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x7d, 0x1c, 0x06],       // vpabsb (%rsi),%ymm0
        vec![0xc4, 0xe3, 0x75, 0x4c, 0x06, 0x20], // vpblendvb %ymm2,(%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe3, 0x71, 0x4c, 0x06, 0x20], // vpblendvb %xmm2,(%rsi),%xmm1,%xmm0
        vec![0xc4, 0xe3, 0x75, 0x0c, 0x06, 0x5a], // vblendps $0x5a,(%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xc6, 0x06, 0x1b],       // vshufpd $0x1b,(%rsi),%ymm1,%ymm0
        vec![0xc5, 0xf4, 0xc6, 0x06, 0x1b],       // vshufps $0x1b,(%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x02, 0x06],       // vphaddd (%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x01, 0x06],       // vphaddw (%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x03, 0x06],       // vphaddsw (%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x05, 0x06],       // vphsubw (%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x07, 0x06],       // vphsubsw (%rsi),%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x2b, 0x06],       // vpackusdw (%rsi),%ymm1,%ymm0
...
/// The register forms of the same kinds, which must stay identical to the interpreter while
/// the memory forms are repaired.
#[cfg(target_arch = "aarch64")]
#[test]
fn x86_vex_register_operand_kinds_match_interpreter_at_each_boundary() {
    let program: Vec<Vec<u8>> = vec![
        vec![0xc5, 0xf5, 0xfe, 0xc2],             // vpaddd %ymm2,%ymm1,%ymm0
        vec![0xc5, 0xf5, 0x60, 0xc2],             // vpunpcklbw %ymm2,%ymm1,%ymm0
        vec![0xc5, 0xf5, 0x6b, 0xc2],             // vpackssdw %ymm2,%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xd5, 0xc2],             // vpmullw %ymm2,%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xe4, 0xc2],             // vpmulhuw %ymm2,%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xe5, 0xc2],             // vpmulhw %ymm2,%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xf4, 0xc2],             // vpmuludq %ymm2,%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xe0, 0xc2],             // vpavgb %ymm2,%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xf6, 0xc2],             // vpsadbw %ymm2,%ymm1,%ymm0
        vec![0xc5, 0xfd, 0x70, 0xc2, 0x1b],       // vpshufd $0x1b,%ymm2,%ymm0
        vec![0xc5, 0xfc, 0x5b, 0xc2],             // vcvtdq2ps %ymm2,%ymm0
        vec![0xc4, 0xe2, 0x7d, 0x1e, 0xc2],       // vpabsd %ymm2,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x0a, 0xc2],       // vpsignd %ymm2,%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x28, 0xc2],       // vpmuldq %ymm2,%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x40, 0xc2],       // vpmulld %ymm2,%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x71, 0x02, 0xc2],       // vphaddd %xmm2,%xmm1,%xmm0
        vec![0xc4, 0xe3, 0x75, 0x0e, 0xc2, 0x5a], // vpblendw $0x5a,%ymm2,%ymm1,%ymm0
        vec![0xc4, 0xe3, 0x75, 0x4c, 0xc2, 0x30], // vpblendvb %ymm3,%ymm2,%ymm1,%ymm0
        vec![0xc5, 0xf5, 0xc6, 0xc2, 0x1b],       // vshufpd $0x1b,%ymm2,%ymm1,%ymm0
        vec![0xc5, 0xf4, 0xc6, 0xc2, 0x1b],       // vshufps $0x1b,%ymm2,%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x02, 0xc2],       // vphaddd %ymm2,%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x05, 0xc2],       // vphsubw %ymm2,%ymm1,%ymm0
        vec![0xc4, 0xe2, 0x75, 0x2b, 0xc2],       // vpackusdw %ymm2,%ymm1,%ymm0
