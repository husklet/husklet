...
use protocol::{
    ...
    MARK_IRREVERSIBLE, MEMBER_EXITED, MEMBER_RESTORED, MEMBER_STDIO, NATIVE_RESTORE, NATIVE_SNAPSHOT, OBJECT_ABORT,
    OBJECT_BEGIN, OBJECT_FINISH, OBJECT_TELL, OBJECT_WRITE, OBJECT_WRITE_AT, PARTICIPANT_REGISTERED, PAYLOAD_MAX,
    RECOVERY_COMPLETE, REFUSAL_LATCHED, REGISTER_READY, RELEASE_EXIT, RELEASE_HOLD, RELEASE_RESUME, RELEASE_WAIT,
    REQUEST_BYTES, Reply, Request, SEAL_MEMBERSHIP, SETTLE_REFUSAL, SOURCE_LIST, SOURCE_READ, SOURCE_SIZE,
