...
pub(crate) struct Service {
    ...
    measurements: Mutex<HashMap<JournalId, crate::BenchmarkMeasurement>>,
    measurement_requests: Mutex<HashMap<ContainerId, std::path::PathBuf>>,
    diagnostic_requests: Mutex<HashMap<ContainerId, std::path::PathBuf>>,
...
impl Service {
    ...
    pub(crate) fn new<S: Storage + 'static>(dependencies: Dependencies<S>) -> Self {
        ...
        Self {
            ...
            measurement_requests: Mutex::new(HashMap::new()),
            diagnostic_requests: Mutex::new(HashMap::new()),
