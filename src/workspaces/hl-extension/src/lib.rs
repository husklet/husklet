...
pub use manifest::{
    Activation, ContainerGrant, ContainerSelector, ExtensionName, FilesystemGrant, Invalid, Manifest, PaneProvider,
    PaneSelection, Presentation, Resources, WorkspaceEnvironmentGrant, WorkspaceEnvironmentSelector,
};
