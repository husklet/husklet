...
_Static_assert(sizeof(hl_a64_host_context) == 800, "aarch64 host context ABI drifted");
_Static_assert(_Alignof(hl_a64_host_context) == 8, "aarch64 host context alignment drifted");
_Static_assert(offsetof(hl_a64_host_context, stack) == 248, "aarch64 host stack offset drifted");
_Static_assert(offsetof(hl_a64_host_context, vectors) == 272, "aarch64 host vector offset drifted");
_Static_assert(offsetof(hl_a64_host_context, fpcr) == 784, "aarch64 host FP offset drifted");

int hl_a64_fault_reconstruct(hl_native_aarch64_cpu *, const hl_a64_host_context *,
