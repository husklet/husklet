...
int hl_x86_projection_resolve(const hl_native_projection *, hl_native_x86_64_cpu *,
                              uint64_t, uint64_t, uint32_t);
int hl_x86_projection_written(hl_native_x86_64_cpu *, uint64_t, uint64_t);
int hl_x86_projection_switch_writable(const hl_native_x86_64_cpu *, uint64_t, uint64_t);
