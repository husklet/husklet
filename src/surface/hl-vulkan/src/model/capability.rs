...
pub enum FormatClass {
    ...
    SampledColor,
    /// Filterable sampled color writable only through the blit executor's corrected attachment path.
    BlitColor,
        ...
        if matches!(
            ...
            Some(
                hl_gpu::protocol::model::enums::TextureFormat::Rgba8Unorm
                    ...
                    | hl_gpu::protocol::model::enums::TextureFormat::Rgba16Uint
                    | hl_gpu::protocol::model::enums::TextureFormat::Rgba16Sint
...
mod tests {
    ...
    #[test]
    fn r16_unorm_is_a_full_native_color_format() {
        let optimal = Format(vk_format::R16_UNORM).features().optimal_tiling;
        assert_ne!(optimal & format_feature::SAMPLED_IMAGE, 0);
        assert_ne!(optimal & format_feature::SAMPLED_IMAGE_FILTER_LINEAR, 0);
        assert_ne!(optimal & format_feature::COLOR_ATTACHMENT, 0);
        assert_ne!(optimal & format_feature::BLIT_SRC, 0);
    ...
    #[test]
    fn r16_snorm_is_a_full_native_color_format() {
        let optimal = Format(vk_format::R16_SNORM).features().optimal_tiling;
        assert_ne!(optimal & format_feature::SAMPLED_IMAGE, 0);
        assert_ne!(optimal & format_feature::SAMPLED_IMAGE_FILTER_LINEAR, 0);
        assert_ne!(optimal & format_feature::COLOR_ATTACHMENT, 0);
        assert_ne!(optimal & format_feature::BLIT_SRC, 0);
    ...
    #[test]
    fn rg16_snorm_is_a_full_native_color_format() {
        let optimal = Format(vk_format::R16G16_SNORM).features().optimal_tiling;
        assert_ne!(optimal & format_feature::SAMPLED_IMAGE, 0);
        assert_ne!(optimal & format_feature::SAMPLED_IMAGE_FILTER_LINEAR, 0);
        assert_ne!(optimal & format_feature::COLOR_ATTACHMENT, 0);
        assert_ne!(optimal & format_feature::BLIT_SRC, 0);
    ...
    #[test]
    fn rgba16_snorm_is_a_full_native_color_format() {
        let optimal = Format(vk_format::R16G16B16A16_SNORM)
            .features()
            .optimal_tiling;
        assert_ne!(optimal & format_feature::SAMPLED_IMAGE, 0);
        assert_ne!(optimal & format_feature::SAMPLED_IMAGE_FILTER_LINEAR, 0);
