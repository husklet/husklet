...
#[test]
fn every_advertised_native_filterable_format_records_a_linear_blit() {
    for src_format in [
        vk_format::R8G8B8A8_SNORM,
        vk_format::A8B8G8R8_SNORM_PACK32,
        vk_format::R16G16_SFLOAT,
        vk_format::A2B10G10R10_UNORM_PACK32,
        vk_format::B4G4R4A4_UNORM_PACK16,
        vk_format::R16G16B16A16_UNORM,
        vk_format::R16G16_UNORM,
        vk_format::R16_UNORM,
        vk_format::R16_SNORM,
        ...
        .unwrap_or_else(|error| {
            panic!("VkFormat {src_format:#x} advertises SAMPLED_IMAGE_FILTER_LINEAR: {error}")
        });
    }
}
