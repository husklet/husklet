...
impl Directives {
    ...
    pub fn emit(&self) {
        ...
        // Vulkan ICDs return pointers to their own entry points through vk_icdGetInstanceProcAddr.
        // Bind those internal references locally so a proc-address we hand the loader can never
        // resolve back into libvulkan's wrapper.
