...
pub(super) fn resolve(name: &str) -> *mut c_void {
    ...
    match name {
        ...
        "glBlendEquationSeparateiEXT" => p!(glBlendEquationSeparatei),
        "glBlendEquationi" => p!(glBlendEquationi),
        "glBlendEquationiEXT" => p!(glBlendEquationi),
        "glBlendFuncSeparatei" => p!(glBlendFuncSeparatei),
        "glBlendFuncSeparateiEXT" => p!(glBlendFuncSeparatei),
        "glBlendFunci" => p!(glBlendFunci),
        "glBlendFunciEXT" => p!(glBlendFunci),
        ...
        "glColorMaskiEXT" => p!(glColorMaski),
        ...
        "glIsEnablediEXT" => p!(glIsEnabledi),
