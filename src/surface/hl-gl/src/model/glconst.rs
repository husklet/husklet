...
pub const GL_CONTEXT_FLAG_DEBUG_BIT: u32 = 0x0000_0002;
pub const GL_STACK_OVERFLOW: u32 = 0x0503;
pub const GL_STACK_UNDERFLOW: u32 = 0x0504;
pub const GL_BUFFER_OBJECT: u32 = 0x82E0;
pub const GL_SHADER_OBJECT: u32 = 0x82E1;
pub const GL_PROGRAM_OBJECT: u32 = 0x82E2;
pub const GL_QUERY_OBJECT: u32 = 0x82E3;
pub const GL_PROGRAM_PIPELINE_OBJECT: u32 = 0x82E4;
pub const GL_SAMPLER_OBJECT: u32 = 0x82E6;
pub const GL_VERTEX_ARRAY_OBJECT: u32 = 0x8074;
