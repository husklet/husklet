...
pub(crate) struct LocalState {
    ...
    pub(crate) cube_tex_unit: [u32; glconst::MAX_TEXTURE_UNITS],
    pub(crate) array_tex_unit: [u32; glconst::MAX_TEXTURE_UNITS],
    pub(crate) tex_3d_unit: [u32; glconst::MAX_TEXTURE_UNITS],
    pub(crate) multisample_tex_unit: [u32; glconst::MAX_TEXTURE_UNITS],
    pub(crate) generate_mipmap_hint: u32,
    ...
    pub(crate) transform_feedback_readbacks: Vec<TransformFeedbackReadback>,
    pub(crate) transform_feedback_cleanup: Vec<hl_gpu::Cmd>,
...
impl Default for LocalState {
    fn default() -> Self {
        Self {
            ...
            cube_tex_unit: [0; glconst::MAX_TEXTURE_UNITS],
            array_tex_unit: [0; glconst::MAX_TEXTURE_UNITS],
            tex_3d_unit: [0; glconst::MAX_TEXTURE_UNITS],
            multisample_tex_unit: [0; glconst::MAX_TEXTURE_UNITS],
            generate_mipmap_hint: glconst::GL_DONT_CARE,
            ...
            transform_feedback_readbacks: Vec::new(),
            transform_feedback_cleanup: Vec::new(),
