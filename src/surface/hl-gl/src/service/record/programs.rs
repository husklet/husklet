...
impl GlContext {
    ...
    pub(super) fn snapshot(&self, capture_buffers: bool) -> DrawCall {
        ...
        let mut d = DrawCall {
            ...
            polygon_offset_fill: ctx.local.pipeline.polygon_offset_fill,
            polygon_offset_factor: ctx.local.pipeline.polygon_offset_factor,
            polygon_offset_units: ctx.local.pipeline.polygon_offset_units,
