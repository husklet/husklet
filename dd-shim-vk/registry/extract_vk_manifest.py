#!/usr/bin/env python3
# dd-shim-vk manifest extractor. Mirrors dd-shim-gl/registry/extract_from_khronos.py and
# dd-shim-cuda/registry/extract_cuda_manifest.py, but reads the Khronos **Vulkan** registry
