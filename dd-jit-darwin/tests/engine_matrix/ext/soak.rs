...
fn soakext() -> Group {
    group(
        ...
        vec![
            ...
            port("manyblocks", "ext_soak/manyblocks.c")
                .out("soak manyblocks acc=9715475295547480376\n"),
            ...
            port("fpaccum", "ext_soak/fpaccum.c")
                .out("soak fpaccum xb=4600877379321698713 yb=4662744287908813514\n"),
            ...
            port("divchurn", "ext_soak/divchurn.c")
                .out("soak divchurn uacc=8510538310492573036 sacc=-1951097741945098340\n"),
            ...
            port("reallocchurn", "ext_soak/reallocchurn.c")
                .out("soak reallocchurn sum=131312824267\n"),
            ...
            port("atomicchurn", "ext_soak/atomicchurn.c")
                .out("soak atomicchurn counter=16000000 cas=16000000\n"),
            ...
            port("signalload", "ext_soak/signalload.c")
                .out("soak signalload hits=800000 work=1001168286810961024\n"),
