 ...
 * `dd-gpu/src/ptx.rs` + `dd-gpu/src/software.rs` (same modeled SIMT subset). It exists so this guest
...
/* =================================================================================================
 * PTX interpreter (mirror of dd-gpu/src/ptx.rs — modeled subset; flat unified addressing)
 * ================================================================================================= */
#define MAX_REG   512
...
/* fixed device identity (matches dd-gpu/src/cuda.rs CudaDeviceDesc::apple_default) */
