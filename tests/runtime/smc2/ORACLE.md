...
This source emits AArch64 instructions at runtime, so its target set is intentionally ARM64-only. It exercises guest RWX execution and precise translated-code invalidation.
