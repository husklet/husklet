...
// timeout. On Linux the EPOLLET registration edge reports an already-readable fd (this is how multi-process
// application's child learns of a bootstrap message the coordinator sent before the child's message loop started). The
