...
int main(void) {
    ...
    struct itimerspec cur2;
    timerfd_gettime(tfd, &cur2);
    int cleared = cur2.it_value.tv_sec == 0 && cur2.it_value.tv_nsec == 0 && cur2.it_interval.tv_sec == 0 &&
                  cur2.it_interval.tv_nsec == 0;
