...
int main(void) {
    ...
    int d1 = strcmp(b, "2023-11-14") == 0;
    strftime(b, sizeof b, "%H:%M:%S", &tmv);
    int d2 = strcmp(b, "22:13:20") == 0;
    strftime(b, sizeof b, "%j", &tmv);
    int d3 = strcmp(b, "318") == 0; // 1-based day of year
    strftime(b, sizeof b, "%w", &tmv);
    int d4 = strcmp(b, "2") == 0; // Tue
    strftime(b, sizeof b, "%F %T", &tmv);
    int d5 = strcmp(b, "2023-11-14 22:13:20") == 0;
