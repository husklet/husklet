...
#define K(i)                                                                                                           \
    __attribute__((noinline)) static uint32_t cold##i(uint32_t s) {                                                    \
        return xs(s + i, 1000 + 17 * i);                                                                               \
    }
K(0)
K(1)
K(2)
...
static uint32_t (*coldtab[32])(uint32_t) = {
    cold0,  cold1,  cold2,  cold3,  cold4,  cold5,  cold6,  cold7,  cold8,  cold9,  cold10,
    cold11, cold12, cold13, cold14, cold15, cold16, cold17, cold18, cold19, cold20, cold21,
    cold22, cold23, cold24, cold25, cold26, cold27, cold28, cold29, cold30, cold31,
};
