...
static long double x87_fprem(long double a, long double b) {
    long double r;
    __asm__ volatile("fprem" : "=t"(r) : "0"(a), "u"(b));
    return r;
}

static long double x87_fprem1(long double a, long double b) {
    long double r;
    __asm__ volatile("fprem1" : "=t"(r) : "0"(a), "u"(b));
    return r;
}

static long double x87_fscale(long double a, long double k) {
    long double r;
    __asm__ volatile("fscale" : "=t"(r) : "0"(a), "u"(k));
    return r;
}

static long double x87_fsqrt(long double a) {
    long double r;
...
static uint64_t hashd(uint64_t h, long double v) {
    double d = (double)v;
    uint64_t u;
    memcpy(&u, &d, 8);
    return h * 1000003ULL + u;
}
...
TGT int main(void) {
    ...
    for (int it = 0; it < 4000; it++) {
        ...
        long double b =
            (long double)((int)((seed >> 21) & 0x7FF) + 1) / 8.0L; // nonzero divisor, modest exponent spread
