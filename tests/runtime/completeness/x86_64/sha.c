...
__attribute__((target("sha,sse4.1,ssse3"))) static long go(void) {
    ...
    // implicit xmm0 -- exercises crypto_rm_vec + the register-alias paths of the ARM lowering.
    {
        ...
        ph("m_rnds2", t);
        t = a;
        asm("sha256msg1 %1, %0" : "+x"(t) : "m"(mem[0]));
        ph("m_msg1", t);
        t = a;
        asm("sha256msg2 %1, %0" : "+x"(t) : "m"(mem[1]));
        ph("m_msg2", t);
        t = a;
        asm("sha1rnds4 $2, %1, %0" : "+x"(t) : "m"(mem[0]));
        ph("m_sha1r4", t);
        t = a;
        asm("sha1nexte %1, %0" : "+x"(t) : "m"(mem[1]));
        ph("m_sha1nexte", t);
        t = a;
        asm("sha1msg1 %1, %0" : "+x"(t) : "m"(mem[0]));
        ph("m_sha1msg1", t);
        t = a;
        asm("sha1msg2 %1, %0" : "+x"(t) : "m"(mem[1]));
        ph("m_sha1msg2", t);
        // aliased dst==src (the SU1 alias path in sha256msg2; read-before-write everywhere else)
        x0 = wk;
        t = a;
        asm("sha256rnds2 %0, %0" : "+x"(t) : "x"(x0));
        ph("al_rnds2", t);
        t = a;
        asm("sha256msg1 %0, %0" : "+x"(t));
        ph("al_msg1", t);
        t = a;
        asm("sha256msg2 %0, %0" : "+x"(t));
        ph("al_msg2", t);
        t = a;
        asm("sha1rnds4 $1, %0, %0" : "+x"(t));
        ph("al_sha1r4", t);
        t = a;
        asm("sha1nexte %0, %0" : "+x"(t));
        ph("al_sha1nexte", t);
        t = a;
        asm("sha1msg1 %0, %0" : "+x"(t));
        ph("al_sha1msg1", t);
        t = a;
        asm("sha1msg2 %0, %0" : "+x"(t));
        ph("al_sha1msg2", t);
        // rnds2 with dst == xmm0 (state, key and WK all in one reg) and src == xmm0
        x0 = wk;
        asm("sha256rnds2 %1, %0" : "+x"(x0) : "x"(a));
        ph("x0_rnds2d", x0);
        x0 = wk;
        t = a;
        asm("sha256rnds2 %1, %0" : "+x"(t) : "x"(x0));
        ph("x0_rnds2s", t);
        // all-in-one: dst == src == xmm0
        x0 = wk;
        asm("sha256rnds2 %0, %0" : "+x"(x0));
        ph("x0_rnds2ds", x0);
    }
    ...
    static const uint32_t kat[8] = {0xba7816bf, 0x8f01cfea, 0x414140de, 0x5dae2223,
