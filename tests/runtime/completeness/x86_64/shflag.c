...
#define C_CASE(a, prn, CST)                                                                                            \
    do {                                                                                                               \
        ...
        if (prn)                                                                                                       \
            printf("C a=%016lx c=%d s1=%016lx s2=%016lx\n", (unsigned long)(a), CST, (unsigned long)s1,                \
                   (unsigned long)s2);                                                                                 \
    } while (0)
...
#define E_CASE(a, b, CST, prn)                                                                                         \
    do {                                                                                                               \
        ...
        if (prn)                                                                                                       \
            printf("E a=%016lx b=%016lx c=%d s=%016lx f=%03lx s2=%08lx f2=%03lx\n", (unsigned long)(a),                \
