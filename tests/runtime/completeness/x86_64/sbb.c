...
#define SBB_RAX(rax, imm, cf_in)                                                                                       \
    do {                                                                                                               \
        ...
        __asm__ volatile("movq %[a], %%rax\n\t" cf_in "\n\t"                                                           \
                         ...
                         : "rax", "cc");                                                                               \
        printf("SBB_RAX rax=%016lx imm=%08x cf=%s -> r=%016lx fl=%03lx\n", (unsigned long)(rax), (unsigned)(imm),      \
               cf_in[0] == 's' ? "1" : "0", _r, _f & FLMASK);                                                          \
    } while (0)
