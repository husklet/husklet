...
#define RUNOP(TAG, OP, PRE)                                                                                            \
    do {                                                                                                               \
        for (unsigned i = 0; i < sizeof V; i++)                                                                        \
            for (unsigned j = 0; j < sizeof V; j++) {                                                                  \
                unsigned long r = 0, f = 0, f2 = 0, f3 = 0, ah = 0, p = 0, jp = 0;                                     \
                uint8_t A = V[i], B = V[j];                                                                            \
                ...
                if ((i * 13 + j) % 17 == 0)                                                                            \
                    printf("%-4s a=%02x b=%02x r=%02lx fl=%03lx dead=%03lx blk=%03lx ah=%02lx p=%lu jp=%lu\n", TAG, A, \
                           B, r & 0xff, f & FLMASK, f2 & FLMASK, f3 & FLMASK, ah & 0x14, p, jp);                       \
            }                                                                                                          \
    } while (0)
...
#define RUNSHIFT(SOP)                                                                                                  \
    do {                                                                                                               \
        for (unsigned i = 0; i < sizeof V; i++) {                                                                      \
            unsigned long f = 0, p = 0, pd = 0;                                                                        \
            uint8_t A = V[i], Bk = 0x33;                                                                               \
