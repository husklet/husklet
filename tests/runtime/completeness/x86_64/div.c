...
#define DIV8(ax, d, sgn)                                                                                               \
    do {                                                                                                               \
        uint16_t res = 0;                                                                                              \
        fpe = 0;                                                                                                       \
        uint16_t _a = (uint16_t)(ax);                                                                                  \
        uint8_t _d = (uint8_t)(d);                                                                                     \
        if (!sigsetjmp(jb, 1)) {                                                                                       \
            if (sgn)                                                                                                   \
                __asm__ volatile("idivb %[dv]" : "=a"(res) : "a"(_a), [dv] "r"(_d) : "cc");                            \
            else                                                                                                       \
                __asm__ volatile("divb  %[dv]" : "=a"(res) : "a"(_a), [dv] "r"(_d) : "cc");                            \
        }                                                                                                              \
        if (fpe)                                                                                                       \
            printf("%s8  ax=%04x d=%02x -> #DE\n", sgn ? "IDIV" : "DIV ", (unsigned)_a, _d);                           \
        else                                                                                                           \
            printf("%s8  ax=%04x d=%02x -> q=%02x r=%02x\n", sgn ? "IDIV" : "DIV ", (unsigned)_a, _d, res & 0xff,      \
                   (res >> 8) & 0xff);                                                                                 \
    } while (0)

/* 16-bit: DX:AX / r16 -> AX=quot, DX=rem. */
#define DIV16(hi, lo, d, sgn)                                                                                          \
    do {                                                                                                               \
        uint16_t q = 0, r = 0;                                                                                         \
        fpe = 0;                                                                                                       \
        ...
        if (!sigsetjmp(jb, 1)) {                                                                                       \
            if (sgn)                                                                                                   \
                __asm__ volatile("idivw %[dv]" : "=a"(q), "=d"(r) : "a"(_lo), "d"(_hi), [dv] "r"(_d) : "cc");          \
            else                                                                                                       \
                __asm__ volatile("divw  %[dv]" : "=a"(q), "=d"(r) : "a"(_lo), "d"(_hi), [dv] "r"(_d) : "cc");          \
        }                                                                                                              \
        if (fpe)                                                                                                       \
            printf("%s16 %04x:%04x / %04x -> #DE\n", sgn ? "IDIV" : "DIV ", _hi, _lo, _d);                             \
        else                                                                                                           \
            printf("%s16 %04x:%04x / %04x -> q=%04x r=%04x\n", sgn ? "IDIV" : "DIV ", _hi, _lo, _d, q, r);             \
    } while (0)

/* 32-bit: EDX:EAX / r32 -> EAX=quot, EDX=rem. */
#define DIV32(hi, lo, d, sgn)                                                                                          \
    do {                                                                                                               \
        uint32_t q = 0, r = 0;                                                                                         \
        fpe = 0;                                                                                                       \
        ...
        if (!sigsetjmp(jb, 1)) {                                                                                       \
            if (sgn)                                                                                                   \
                __asm__ volatile("idivl %[dv]" : "=a"(q), "=d"(r) : "a"(_lo), "d"(_hi), [dv] "r"(_d) : "cc");          \
            else                                                                                                       \
                __asm__ volatile("divl  %[dv]" : "=a"(q), "=d"(r) : "a"(_lo), "d"(_hi), [dv] "r"(_d) : "cc");          \
        }                                                                                                              \
        if (fpe)                                                                                                       \
            printf("%s32 %08x:%08x / %08x -> #DE\n", sgn ? "IDIV" : "DIV ", _hi, _lo, _d);                             \
        else                                                                                                           \
            printf("%s32 %08x:%08x / %08x -> q=%08x r=%08x\n", sgn ? "IDIV" : "DIV ", _hi, _lo, _d, q, r);             \
    } while (0)

/* 64-bit: RDX:RAX / r64 -> RAX=quot, RDX=rem. */
#define DIV64(hi, lo, d, sgn)                                                                                          \
    do {                                                                                                               \
        uint64_t q = 0, r = 0;                                                                                         \
        fpe = 0;                                                                                                       \
        ...
        if (!sigsetjmp(jb, 1)) {                                                                                       \
            if (sgn)                                                                                                   \
                __asm__ volatile("idivq %[dv]" : "=a"(q), "=d"(r) : "a"(_lo), "d"(_hi), [dv] "r"(_d) : "cc");          \
            else                                                                                                       \
                __asm__ volatile("divq  %[dv]" : "=a"(q), "=d"(r) : "a"(_lo), "d"(_hi), [dv] "r"(_d) : "cc");          \
        }                                                                                                              \
        if (fpe)                                                                                                       \
            printf("%s64 %016llx:%016llx / %016llx -> #DE\n", sgn ? "IDIV" : "DIV ", (ull)_hi, (ull)_lo, (ull)_d);     \
        else                                                                                                           \
            printf("%s64 %016llx:%016llx / %016llx -> q=%016llx r=%016llx\n", sgn ? "IDIV" : "DIV ", (ull)_hi,         \
                   (ull)_lo, (ull)_d, (ull)q, (ull)r);                                                                 \
    } while (0)
