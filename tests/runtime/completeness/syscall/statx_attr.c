...
int main(void) {
    ...
    int core_mask = (stx.stx_mask & STATX_TYPE) && (stx.stx_mask & STATX_MODE) && (stx.stx_mask & STATX_SIZE) &&
                    (stx.stx_mask & STATX_NLINK) && (stx.stx_mask & STATX_INO);
