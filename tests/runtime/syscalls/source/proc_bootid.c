...
int main(void) {
    ...
    if (boot_ok)
        ...
        printf("BOOTID_FAIL ra=%d valid=%d stable=%d\n", ra, ra > 0 && is_uuid(a), ra > 0 && rb > 0 && !strcmp(a, b));
