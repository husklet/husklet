...
// cross-process command-buffer pattern: one shared-memory object, mmap'd independently in each
...
//     via the parent's independent VA. Exactly the independently mapped peer split.
//
