#!/usr/bin/env python3
# dd-shim-cudart manifest extractor. The CUDA analogue of dd-shim-cuda/registry/extract_cuda_manifest.py,
...
# vendor header.
#
# Source of truth: dd's own `dd-gpu/cuda/cudart_shim.c` — the hand-rolled clean-room CUDA Runtime API
