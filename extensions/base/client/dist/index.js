...
export function workspace(session, { signal } = {}) {
    ...
    const api = {
        ...
        extensions: {
            ...
            install: async (job, revision, imageDigest, granted, containers = { selectors: [], create: false }, networks = { selectors: [], create: false }, filesystem = { read: [], write: [], create: [], delete: [], rename: [] }, workspaceEnvironment = { read: [], write: [] }) => expect(await session.call('extension_install', {
                job,
                revision,
            ...
            update: async (job, revision, imageDigest, granted, containers = { selectors: [], create: false }, networks = { selectors: [], create: false }, filesystem = { read: [], write: [], create: [], delete: [], rename: [] }, workspaceEnvironment = { read: [], write: [] }) => expect(await session.call('extension_update', {
                job,
                revision,
                image_digest: immutableDigest(imageDigest, 'extension candidate image'),
                granted,
        ...
        files: {
            ...
            createObserved: async (path, contents) => expect(await session.call('filesystem_create_observed', { path, contents: [...contents] }), 'identity'),
    ...
    const commitAcquisitionAndWait = async (operation, job, revision, granted, containers = { selectors: [], create: false }, networks = { selectors: [], create: false }, filesystem = { read: [], write: [], create: [], delete: [], rename: [] }, { timeoutMs = 30_000, workspaceEnvironment = { read: [], write: [] } } = {}) => {
        ...
        let timer;
        try {
            const committed = await api.extensions[operation](job, revision, digest, granted, containers, networks, filesystem, workspaceEnvironment);
    ...
    api.extensions.installAndWait = (job, revision, granted, containers, networks, filesystem, options) => commitAcquisitionAndWait('install', job, revision, granted, containers, networks, filesystem, options);
    api.extensions.updateAndWait = (job, revision, granted, containers, networks, filesystem, options) => commitAcquisitionAndWait('update', job, revision, granted, containers, networks, filesystem, options);
