...
groups
  ...
  .push(
    ...
    '- `host.containers.execStreaming(id, generation, options, onPage)` — executes by immutable container ID, optionally resolves credential keys directly into process environment variables, delivers bounded output pages with callback backpressure, cancels on abort or callback failure, and returns the execution ID and completed summary without auto-removing the record.',
