...
function fake() {
  ...
  return { calls, api: {
    ...
    terminal: { tabs: record('terminal.tabs'), topology: record('terminal.topology'), read: record('terminal.read'), writeInput: record('terminal.writeInput'), openTab: record('terminal.openTab'), split: record('terminal.split'), splitObserved: record('terminal.splitObserved'), spawn: record('terminal.spawn'), spawnObserved: record('terminal.spawnObserved'), focus: record('terminal.focus'), retitle: record('terminal.retitle'), resizeGrid: record('terminal.resizeGrid'), ratio: record('terminal.ratio'), ratioObserved: record('terminal.ratioObserved'), close: record('terminal.close'), closeObserved: record('terminal.closeObserved'), switchOccupant: record('terminal.switchOccupant'), switchOccupantObserved: record('terminal.switchOccupantObserved') },
