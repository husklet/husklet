...
use ash::vk::Handle;
use core::ffi::c_void;
use hl_shim::ir::encode_stream;
use hl_shim::transport::{self, Surface, DRM_FMT_XRGB8888};

fn tex_format_of(f: vk::Format) -> hl_shim::ir::TextureFormat {
...
mod tests {
    ...
    fn present_failures_preserve_ir_ownership_and_waits_until_transactional_commit() {
        ...
        reg::lock().record(hl_shim::ir::Cmd::DestroyBuffer(0x1234));
