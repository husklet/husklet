...
/// The present/draw path is deliberately excluded this increment (glClear, glDrawArrays,
/// glDrawElements, eglSwapBuffers, eglCreateWindowSurface remain generated stubs).
