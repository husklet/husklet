...
//!
//!   cargo run -p hl-jit-darwin --example matrix                 # everything, every engine
//!   cargo run -p hl-jit-darwin --example matrix -- container    # only groups/cases matching "container"
//!   cargo run -p hl-jit-darwin --example matrix -- -e x86_64    # only the x86-64 engine
//!   cargo run -p hl-jit-darwin --example matrix -- --list       # list groups + cases without running
