...
//!
//!   cargo run -p dd-term-core --example demo -- /tmp/demo.png

use dd_term_core::layout::{Dir, Layout, Rect};
use dd_term_core::pty::local::LocalPty;
use dd_term_core::render::CpuRenderer;
use dd_term_core::{PtyBackend, Vt};
...
impl Canvas {
    ...
    fn blit(&mut self, ox: u32, oy: u32, img: &dd_term_core::render::Image) {
...
fn title_img(text: &str, cols: usize) -> dd_term_core::render::Image {
...
fn main() {
    ...
    let png = dd_term_core::png::encode_rgba(canvas.w, canvas.h, &canvas.px);
