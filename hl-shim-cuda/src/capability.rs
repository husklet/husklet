...
//! PTX subset — see [`hl_gpu::ptx`]); and `unsupported` when it always returns a defined CUDA error
...
/// `hl_gpu::cuda::CudaDeviceDesc::apple_default`. Advertised as ABI; the *executed* PTX is the bounded
