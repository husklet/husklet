#!/usr/bin/env python3
# dd-shim-cuda manifest extractor. Mirrors dd-shim-gl/registry/extract_from_khronos.py, but the
...
#
# Source of truth: dd's own `dd-gpu/cuda/cuda_shim.c` — the hand-rolled clean-room CUDA Driver API
