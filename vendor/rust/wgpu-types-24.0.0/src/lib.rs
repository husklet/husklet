...
pub enum TextureFormat {
    ...
    Rg11b10Ufloat,
    /// R5G6B5 packed normalized color, exposed by Metal for Vulkan translation.
    R5g6b5Unorm,
    /// A1R5G5B5 packed normalized color, exposed by Metal for Vulkan translation.
    A1r5g5b5Unorm,
    /// B4G4R4A4 packed normalized color, exposed through a swizzled Metal texture view.
    B4g4r4a4Unorm,
...
impl TextureFormat {
    ...
    pub fn guaranteed_format_features(&self, device_features: Features) -> TextureFormatFeatures {
        ...
        let (
            ...
            Self::R5g6b5Unorm =>          (msaa_resolve, attachment),
            Self::A1r5g5b5Unorm =>        (msaa_resolve, attachment),
            Self::B4g4r4a4Unorm =>        (msaa_resolve, attachment),
    ...
    pub fn sample_type(
        ...
        match *self {
            ...
            Self::R5g6b5Unorm | Self::A1r5g5b5Unorm | Self::B4g4r4a4Unorm => Some(float),
    ...
    pub fn block_copy_size(&self, aspect: Option<TextureAspect>) -> Option<u32> {
        match *self {
            ...
            Self::R5g6b5Unorm | Self::A1r5g5b5Unorm | Self::B4g4r4a4Unorm => Some(2),
    ...
    pub fn components_with_aspect(&self, aspect: TextureAspect) -> u8 {
        match *self {
            ...
            Self::Rgb9e5Ufloat | Self::Rg11b10Ufloat | Self::R5g6b5Unorm => 3,
            Self::Rgb10a2Uint | Self::Rgb10a2Unorm | Self::A1r5g5b5Unorm | Self::B4g4r4a4Unorm => 4,
