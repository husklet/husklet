...
impl<I: Iterator<Item = u32>> Frontend<I> {
    ...
    fn parse_global_variable(
        ...
        } = module.types[ty].inner
        {
        ...
        } else if let crate::TypeInner::BindingArray { base, size } = module.types[ty].inner {
            if let crate::TypeInner::Image {
                dim,
                arrayed,
            ...
            {
                // Storage-image access decorations live on OpVariable, not OpTypeImage. Preserve them when
                // the variable points at an array of images just as the scalar-image path above does.
                ...
                ty = module.types.insert(
                    crate::Type {
                        name: None,
                        inner: crate::TypeInner::BindingArray { base: image, size },
                    },
                    Default::default(),
                );
            }
