...
pub enum BindingError {
    ...
    #[error("SPIR-V texel buffer reached wgpu-core before host lowering")]
    UnloweredTexelBuffer,
        ...
        Ok(match self.ty {
            ...
            ResourceType::Texture {
                ...
                let view_dimension = match dim {
                    naga::ImageDimension::Buffer => {
                        return Err(BindingError::UnloweredTexelBuffer)
                    }
                    naga::ImageDimension::D1 => wgt::TextureViewDimension::D1,
