...
list.navigation-sidebar > row.dd-batch { background-color: alpha(@hl_accent, 0.20); box-shadow: inset 3px 0 0 0 @hl_accent; }
...
button.dd-seg:hover { background-color: @hl_fill; }
.dd-seg.dd-active { color: @hl_green; font-weight: 700; }
...
menubutton.dd-seg > button:hover { background-color: @hl_fill; }

/* Status dot. */
.dd-dot { min-width: 8px; min-height: 8px; border-radius: 50%; background-color: alpha(@theme_fg_color, 0.35); }
.dd-dot.success { background-color: @hl_green; }
.dd-dot.error { background-color: @hl_red; }
.dd-dot.warn { background-color: @hl_amber; }
...
.dd-btn:hover { background-color: @hl_fill_hi; background-image: none; }
.dd-btn.suggested-action { background-color: @hl_accent; color: #ffffff; }
.dd-btn.suggested-action:hover { background-color: @hl_accent_hi; }
...
.dd-btn.dd-danger { background-color: alpha(@hl_red, 0.12); color: @hl_red; box-shadow: inset 0 0 0 1px alpha(@hl_red, 0.4); }
.dd-btn.dd-danger:hover { background-color: @hl_red; color: #ffffff; box-shadow: none; }

/* Context popover. */
popover.dd-pop { background: transparent; }
popover.dd-pop > arrow { background: transparent; border: none; }
popover.dd-pop > contents { padding: 4px; border-radius: 6px; background-color: @theme_base_color; border: 1px solid @hl_line; }
.dd-popitem {
  background: none; background-color: transparent; border: none; box-shadow: none; outline: none;
  min-height: 0; border-radius: 6px; padding: 5px 10px; font-weight: 400;
}
.dd-popitem:hover { background-color: @hl_fill; }
.dd-popitem.dd-active { color: @hl_accent; font-weight: 600; }
...
.dd-update { background-color: @hl_accent; color: #ffffff; border: none; box-shadow: none; border-radius: 6px; padding: 3px 11px; font-weight: 600; min-height: 0; }
.dd-update:hover { background-color: @hl_accent_hi; }
...
.dd-stat-card { background-color: @theme_base_color; border: 1px solid @hl_line; border-radius: 6px; padding: 13px 15px; }
.dd-stat-value { font-size: 27px; font-weight: 800; letter-spacing: -0.02em; }
.dd-stat-value.accent { color: @hl_green; }
.dd-stat-name { font-size: 11.5px; font-weight: 600; color: @hl_text_dim; letter-spacing: 0.04em; }
.dd-update-card { background-color: alpha(@hl_accent, 0.10); border: 1px solid alpha(@hl_accent, 0.30); border-radius: 6px; padding: 13px 15px; }
.dd-mono { font-family: 'SF Mono', 'Menlo', monospace; font-size: 12px; }
.dd-step-card { background-color: @theme_base_color; border: 1px solid @hl_line; border-radius: 6px; padding: 11px 15px; }
.dd-code {
...
.dd-sub { font-size: 13.5px; color: @hl_text_dim; }
.dd-onboard-status { font-size: 13.5px; font-weight: 600; }
.dd-onboard-head { font-size: 15px; font-weight: 700; }
.dd-cli-msg { font-family: 'SF Mono', 'Menlo', monospace; font-size: 11px; background-color: @hl_fill; border-radius: 6px; padding: 8px 10px; margin-top: 6px; }
...
.dd-section-title { font-size: 0.72em; font-weight: 700; color: @hl_text_faint; letter-spacing: 0.07em; }
...
.dd-listrow:hover { background-color: @hl_fill; }
.dd-listrow-title { font-weight: 600; font-size: 13px; }
.dd-listrow-sub { font-size: 12px; color: @hl_text_dim; }

/* Key/value detail line. */
.dd-kv-key { font-size: 12.5px; color: @hl_text_dim; min-width: 96px; }
.dd-kv-val { font-size: 13px; }

/* Status badge / chip. */
.dd-badge { font-size: 10.5px; font-weight: 700; letter-spacing: 0.03em; padding: 1px 7px; border-radius: 6px; background-color: @hl_fill; }
.dd-badge.run { color: @hl_green; background-color: alpha(@hl_green, 0.14); }
.dd-badge.stop { color: alpha(@theme_fg_color, 0.6); }
.dd-badge.fail { color: @hl_red; background-color: alpha(@hl_red, 0.13); }

/* Detail pane title + toolbar. */
.dd-detail-title { font-size: 17px; font-weight: 800; letter-spacing: -0.01em; }
.dd-detail-sub { font-size: 12.5px; color: @hl_text_dim; }
.dd-toolbar { padding: 0; }

/* Hairline separators between sections. */
.dd-hsep { background-color: @hl_line_soft; min-height: 1px; }
.dd-empty { font-size: 13px; color: @hl_text_faint; }
...
.dd-termbook tab:checked { background: none; color: @theme_fg_color; border-bottom-color: @hl_accent; }
.dd-termbook tab label { color: inherit; font-weight: inherit; }
.dd-tabclose { font-size: 11px; opacity: 0.45; padding: 0 1px; }
.dd-tabclose:hover { opacity: 1; background-color: @hl_fill; }
";
