...
#
#   hl-gui/mac/mac-image.sh base            # lean userland  -> image name "ddmac-base"
#   hl-gui/mac/mac-image.sh dev             # full dev set   -> image name "ddmac-dev"   (default)
#   hl-gui/mac/mac-image.sh dev <out-dir>   # custom output dir (default: $DD_IMAGES/<name>)
#
