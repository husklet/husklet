...
| `compositor_retains_presentation_feedback_across_retryable_failure_only` | contradictory | Failure classification does not behaviorally prove coupled retry/terminal cleanup | Drive fail-fail-deliver and terminal-fail with exact-once protocol evidence |
