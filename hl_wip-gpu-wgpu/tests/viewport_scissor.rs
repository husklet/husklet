...
fn viewport_transforms_and_scissor_clips_to_exact_subrect() {
        ...
        &[
            ...
            Cmd::Submit(CommandBuffer {
                encoder: vec![
                    ...
                    Enc::SetPipeline(1),
                    Enc::SetViewport { x: 4.0, y: 4.0, w: 24.0, h: 16.0, min_depth: 0.0, max_depth: 1.0 },
                    Enc::SetScissor { x: 10, y: 8, w: 14, h: 20 },
    ...
    assert_eq!(filled, 14 * 12, "the clipped draw must cover exactly the 14×12 intersection rect");
    eprintln!("demo `viewport_scissor`: exact 14×12 intersection — PNG at {OUT_DIR}/viewport_scissor.png");
}
