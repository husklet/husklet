...
fn run_batch(exec: &mut WgpuExecutor, cmds: &[Cmd]) -> Session {
    ...
    hl_gpu::runtime::submit(&mut s, exec, 0, cmds)
        .expect("the declared-but-unsampled bind group must create + draw cleanly (explicit layout)");
    s
}
...
fn bound_but_unsampled_bindings_filtered_to_used() {
    ...
    let s = run_batch(
        ...
        &[
            ...
            Cmd::CreateTexture(3, tex(1, 1, texture_usage::SAMPLED | texture_usage::COPY_DST)),
            ...
            Cmd::CreateBindGroup(
                ...
                BindGroupDesc {
                    ...
                    entries: vec![
                        ...
                        BindEntry { binding: 3, resource: BindResource::Texture { id: 3 } },
                        BindEntry { binding: 4, resource: BindResource::Sampler { id: 2 } },
                    ],
                },
            ),
            Cmd::Submit(CommandBuffer {
                encoder: vec![
                    ...
                    Enc::CopyBufferToTexture { src: 3, src_offset: 0, bytes_per_row: 4, dst: 3, mip: 0, width: 1, height: 1 },
                    Enc::BeginRenderPass {
