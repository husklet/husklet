...
fn instanced_draw_reads_per_instance_geometry_from_a_vertex_storage_buffer() {
    ...
    hl_gpu::runtime::submit(
        ...
        &[
            ...
            Cmd::CreateBuffer(2, BufferDesc { size: 32, usage: buffer_usage::STORAGE, label: String::new() }),
            ...
            Cmd::CreateBindGroup(
                ...
                BindGroupDesc {
                    set: 0,
                    entries: vec![BindEntry { binding: 0, resource: BindResource::Buffer { id: 1, offset: 0, size: 8 } }],
                },
            ),
            Cmd::CreateBindGroup(
                2,
                BindGroupDesc {
                    set: 1,
                    entries: vec![BindEntry { binding: 0, resource: BindResource::Buffer { id: 2, offset: 0, size: 32 } }],
                },
            ),
            Cmd::Submit(CommandBuffer {
                encoder: vec![
                    ...
                    Enc::Draw { vertex_count: 4, instance_count: 2, first_vertex: 0, first_instance: 0 },
                    Enc::EndRenderPass,
                ],
                signal: None,
            }),
