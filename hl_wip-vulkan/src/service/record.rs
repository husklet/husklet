...
pub fn cmd_copy_buffer_to_image(
    ...
    let bpt = dst_fmt
        .bytes_per_texel()
        .ok_or(GpuError::Unsupported("vkCmdCopyBufferToImage: image format has no packed texel layout"))?
        as u32;
...
pub fn cmd_copy_image_to_buffer(
    ...
    let bpt = src_fmt
        .bytes_per_texel()
        .ok_or(GpuError::Unsupported("vkCmdCopyImageToBuffer: image format has no packed texel layout"))?
        as u32;
    let bytes_per_row = buffer_image_bytes_per_row(
        buffer_offset,
        row_length_texels,
