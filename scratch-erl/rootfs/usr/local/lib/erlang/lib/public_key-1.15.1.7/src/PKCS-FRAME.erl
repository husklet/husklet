...
-asn1_info([{vsn,'5.2.2.1'},
            {module,'PKCS-FRAME'},
            {options,[{i,"/usr/src/otp_src_26.2.5.21/lib/public_key/asn1/../src"},
 warnings,ber,errors,
 {cwd,"/usr/src/otp_src_26.2.5.21/lib/public_key/asn1"},
 {outdir,"/usr/src/otp_src_26.2.5.21/lib/public_key/asn1/../src"},
 der,noobj,asn1config,
 {i,"."},
 {i,"/usr/src/otp_src_26.2.5.21/lib/public_key/asn1"}]}]).
