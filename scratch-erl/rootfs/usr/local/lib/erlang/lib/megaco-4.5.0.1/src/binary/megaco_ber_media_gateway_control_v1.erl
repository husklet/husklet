%% Generated by the Erlang ASN.1 BER compiler. Version: 5.2.2.1
...
-asn1_info([{vsn,'5.2.2.1'},
            {module,'megaco_ber_media_gateway_control_v1'},
            {options,[warnings,ber,errors,
 {cwd,"/usr/src/otp_src_26.2.5.21/lib/megaco/src/binary"},
 {outdir,"/usr/src/otp_src_26.2.5.21/lib/megaco/src/binary"},
 noobj,legacy_erlang_types,asn1config,
 {i,"."},
 {i,"/usr/src/otp_src_26.2.5.21/lib/megaco/src/binary"}]}]).
...
'dialyzer-suppressions'(Arg) ->
    _ = encode_bit_string(element(1, Arg), element(2, Arg), element(3, Arg), element(4, Arg)),
    ok.
