...
yeccpars2_9_(__Stack0) ->
 ...
 [begin
                         w("Sloppy assignment on line ~p", [line_of(___1)]), ___1
  end | __Stack].
...
yeccpars2_17_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'AGENT-CAPABILITIES'}
  end | __Stack].
...
yeccpars2_18_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'AutonomousType'}
  end | __Stack].
...
yeccpars2_19_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'BITS'}
  end | __Stack].
...
yeccpars2_21_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'DateAndTime'}
  end | __Stack].
...
yeccpars2_22_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'DisplayString'}
  end | __Stack].
...
yeccpars2_24_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'InstancePointer'}
  end | __Stack].
...
yeccpars2_26_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'MODULE-COMPLIANCE'}
  end | __Stack].
...
yeccpars2_27_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'MODULE-IDENTITY'}
  end | __Stack].
...
yeccpars2_28_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'MacAddress'}
  end | __Stack].
...
yeccpars2_29_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'NOTIFICATION-GROUP'}
  end | __Stack].
...
yeccpars2_30_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'NOTIFICATION-TYPE'}
  end | __Stack].
...
yeccpars2_32_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'OBJECT-GROUP'}
  end | __Stack].
...
yeccpars2_33_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'OBJECT-IDENTITY'}
  end | __Stack].
...
yeccpars2_36_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'PhysAddress'}
  end | __Stack].
...
yeccpars2_37_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'RowPointer'}
  end | __Stack].
...
yeccpars2_38_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'RowStatus'}
  end | __Stack].
...
yeccpars2_39_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'StorageType'}
  end | __Stack].
...
yeccpars2_40_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'TAddress'}
  end | __Stack].
...
yeccpars2_41_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'TDomain'}
  end | __Stack].
...
yeccpars2_42_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'TEXTUAL-CONVENTION'}
  end | __Stack].
...
yeccpars2_44_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'TestAndIncr'}
  end | __Stack].
...
yeccpars2_45_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'TimeInterval'}
  end | __Stack].
...
yeccpars2_46_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'TimeStamp'}
  end | __Stack].
...
yeccpars2_48_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'TruthValue'}
  end | __Stack].
...
yeccpars2_49_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
         ensure_ver(2,___1), {builtin, 'VariablePointer'}
  end | __Stack].
...
yeccpars2_51_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
                           filter_v2imports(get(snmp_version), val(___1))
  end | __Stack].
...
-dialyzer({nowarn_function, 'yeccpars2_70_MODULE-IDENTITY'/1}).
-compile({nowarn_unused_function,  'yeccpars2_70_MODULE-IDENTITY'/1}).
