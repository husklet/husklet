...
yeccpars2_17(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_where_defs(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).
...
yeccpars2_27(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 NewStack = yeccpars2_27_(Stack),
 yeccgoto_futype_list(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).
...
yeccpars2_32(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_utype(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).
...
yeccpars2_134(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_etype(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).
...
yeccpars2_150(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_ref(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).
...
-compile({nowarn_unused_function,  yeccgoto_aref/7}).
...
-compile({nowarn_unused_function,  yeccgoto_def/7}).
...
-compile({nowarn_unused_function,  yeccgoto_defs/7}).
...
-compile({nowarn_unused_function,  yeccgoto_func_type/7}).
...
-compile({nowarn_unused_function,  yeccgoto_futype_list/7}).
...
-compile({nowarn_unused_function,  yeccgoto_lref/7}).
yeccgoto_lref(2=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_151(_S, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccgoto_mref/7}).
-compile({nowarn_unused_function,  yeccgoto_mref/7}).
...
-compile({nowarn_unused_function,  yeccgoto_nutype/7}).
...
-compile({nowarn_unused_function,  yeccgoto_ptype/7}).
...
-compile({nowarn_unused_function,  yeccgoto_ptypes/7}).
...
-compile({nowarn_unused_function,  yeccgoto_utype_list/7}).
...
-compile({nowarn_unused_function,  yeccgoto_utype_map/7}).
...
-compile({nowarn_unused_function,  yeccgoto_utype_map_field/7}).
...
-compile({nowarn_unused_function,  yeccgoto_utype_map_fields/7}).
yeccgoto_utype_map_fields(96, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_97(97, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccgoto_utype_tuple/7}).
-compile({nowarn_unused_function,  yeccgoto_utype_tuple/7}).
...
-compile({nowarn_unused_function,  yeccgoto_utypes/7}).
...
yeccpars2_16_(__Stack0) ->
 ...
 [begin
       ...
       #t_typedef{name = #t_name{name = tok_val(___1)},
		  args = ___2,
		  defs = ___3}
  end | __Stack].
...
-dialyzer({nowarn_function, 'yeccpars2_27_$end'/1}).
-compile({nowarn_unused_function,  'yeccpars2_27_$end'/1}).
-file("edoc_parser.yrl", 116).
'yeccpars2_27_$end'(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
                    
	if length(element(1, ___1)) == 1 ->
		%% there must be exactly one utype in the list
                #t_paren{type = hd(element(1, ___1))};
	   length(element(1, ___1)) == 0 ->
		return_error(element(2, ___1), "syntax error before: ')'");
	   true ->
		return_error(element(2, ___1), "syntax error before: ','")
	end
  end | __Stack].
...
-dialyzer({nowarn_function, yeccpars2_27_atom/1}).
-compile({nowarn_unused_function,  yeccpars2_27_atom/1}).
-file("edoc_parser.yrl", 116).
...
-dialyzer({nowarn_function, yeccpars2_27_string/1}).
-compile({nowarn_unused_function,  yeccpars2_27_string/1}).
-file("edoc_parser.yrl", 116).
...
-dialyzer({nowarn_function, yeccpars2_27_var/1}).
-compile({nowarn_unused_function,  yeccpars2_27_var/1}).
-file("edoc_parser.yrl", 116).
...
-dialyzer({nowarn_function, yeccpars2_27_where/1}).
-compile({nowarn_unused_function,  yeccpars2_27_where/1}).
-file("edoc_parser.yrl", 116).
...
yeccpars2_28_(__Stack0) ->
 ...
 [begin
       ...
       #t_def{name =  #t_var{name = tok_val(___1)},
	      type = ___3}
  end | __Stack].
...
-dialyzer({nowarn_function, 'yeccpars2_39_$end'/1}).
-compile({nowarn_unused_function,  'yeccpars2_39_$end'/1}).
-file("edoc_parser.yrl", 106).
'yeccpars2_39_$end'(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
                #t_atom{val = tok_val(___1)}
  end | __Stack].
...
-dialyzer({nowarn_function, yeccpars2_39_atom/1}).
-compile({nowarn_unused_function,  yeccpars2_39_atom/1}).
-file("edoc_parser.yrl", 106).
...
-dialyzer({nowarn_function, yeccpars2_39_string/1}).
-compile({nowarn_unused_function,  yeccpars2_39_string/1}).
-file("edoc_parser.yrl", 106).
...
-dialyzer({nowarn_function, yeccpars2_39_var/1}).
-compile({nowarn_unused_function,  yeccpars2_39_var/1}).
-file("edoc_parser.yrl", 106).
...
-dialyzer({nowarn_function, yeccpars2_39_where/1}).
-compile({nowarn_unused_function,  yeccpars2_39_where/1}).
-file("edoc_parser.yrl", 106).
...
yeccpars2_50_(__Stack0) ->
 [___3,___2,___1 | __Stack] = __Stack0,
 [begin
                           annotate(union(___3), tok_val(___1))
  end | __Stack].
...
yeccpars2_57_(__Stack0) ->
 [___3,___2,___1 | __Stack] = __Stack0,
 [begin
                               #t_integer_range{from = tok_val(___1),
                                                  to = tok_val(___3)}
  end | __Stack].
...
yeccpars2_58_(__Stack0) ->
 ...
 [begin
             ...
             case {tok_val(___1), element(1, ___2)} of
                 {nil, []} ->
...
yeccpars2_61_(__Stack0) ->
 [___3,___2,___1 | __Stack] = __Stack0,
 [begin
                               {lists:reverse(___2), tok_line(___1)}
  end | __Stack].
...
yeccpars2_82_(__Stack0) ->
 ...
 [begin
        ...
        #t_binary{base_size = ___2, unit_size = ___4}
  end | __Stack].
...
yeccpars2_91_(__Stack0) ->
 ...
 [begin
	...
	#t_type{name = #t_name{app = tok_val(___2),
			       module = qname(___4),
			       name = tok_val(___6)},
		args = element(1, ___7)}
  end | __Stack].
...
yeccpars2_111_(__Stack0) ->
 ...
 [begin
        ...
        #t_record{name = #t_atom{val = tok_val(___2)}}
  end | __Stack].
...
yeccpars2_113_(__Stack0) ->
 ...
 [begin
	...
	#t_field{name = #t_atom{val = tok_val(___1)}, type = ___3}
  end | __Stack].
...
yeccpars2_118_(__Stack0) ->
 ...
 [begin
	...
	#t_fun{args = element(1, ___1), range = ___3}
  end | __Stack].
...
yeccpars2_122_(__Stack0) ->
 ...
 [begin
	...
	#t_type{name = #t_name{module = qname(___1),
			       name = tok_val(___3)},
		args = element(1, ___4)}
  end | __Stack].
...
-file("edoc_parser.yrl", 191).
yeccpars2_127_(__Stack0) ->
 [___6,___5,___4,___3,___2,___1 | __Stack] = __Stack0,
 [begin
                                     
       build_def(tok_val(___1), ___2, ___3, ___6)
  end | __Stack].
...
yeccpars2_145_(__Stack0) ->
 ...
 [begin
    ...
    #t_spec{name = ___1, type = ___2, defs = ___3}
  end | __Stack].
...
yeccpars2_161_(__Stack0) ->
 ...
 [begin
    ...
    edoc_refs:app(tok_val(___2), ___4)
  end | __Stack].
...
yeccpars2_166_(__Stack0) ->
 ...
 [begin
    ...
    edoc_refs:function(qname(___1), tok_val(___3), tok_val(___5))
  end | __Stack].

-compile({inline,yeccpars2_167_/1}).
-dialyzer({nowarn_function, yeccpars2_167_/1}).
-compile({nowarn_unused_function,  yeccpars2_167_/1}).
-file("edoc_parser.yrl", 224).
yeccpars2_167_(__Stack0) ->
 [___5,___4,___3,___2,___1 | __Stack] = __Stack0,
 [begin
                               
    edoc_refs:type(qname(___1), tok_val(___3))
  end | __Stack].
