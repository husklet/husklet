...
- [ ] Approved
- Timestamp: `1785820518113160391`
- Domain: `containers`
- Package: `hl_engine`
- Rule: `file-length`
- Severity: `error`
- Source: `src/containers/hl-engine/src/ffi/linux/execution/path/metadata.rs:1:1`
- Queue: `unclassified`
- lines: `574`
- limit: `500`
...
Rust source contains 574 lines; the maximum is 500
