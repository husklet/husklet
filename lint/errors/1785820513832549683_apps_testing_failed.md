...
- [ ] Approved
- Timestamp: `1785820513832549683`
- Domain: `apps`
- Package: `testing`
- Rule: `struct-noun-naming`
- Severity: `error`
- Source: `src/apps/testing/src/bench/execution.rs:27:1`
- Queue: `unclassified`
- Kind: `struct`

## Finding

`Failed` violates the noun/struct rule: type name is an adjective or past participle; name the value it represents
