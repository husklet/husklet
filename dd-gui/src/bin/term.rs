...
//!
//! Build + run on macOS: `nix develop ./nix -c cargo run -p dd-gui --bin dd-term`.
...
use dd_term_core::config::{CursorShape, TermConfig};
use dd_term_core::session::{self, Pane, PaneNode, Session, SessionTab, SplitDir};
use dd_term_core::workspace::{Arch, CudaDevice, Mount, VpnConfig, Workspace, WorkspaceStore};
