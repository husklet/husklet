...
fn parse_global_decl(line: &str) -> Option<GlobalVar> {
    ...
    while matches!(tok, ".visible" | ".extern" | ".weak" | ".common" | ".hidden" | ".protected") {
        tok = toks.next()?;
    }
    ...
    Some(GlobalVar { name: name.to_string(), size: elem * vec_width * count })
}
...
impl PtxModule {
    ...
    pub fn parse(source: &str) -> Self {
        ...
        Self { source: source.to_string(), entries, globals }
    }
}
