...
impl Registry {
    pub fn new() -> Self {
        Self { modules: HashMap::new(), functions: HashMap::new(), next_handle: 1 }
    }
    ...
    pub fn register_fatbinary(&mut self, ctx: &mut CudaContext, image: &[u8]) -> Result<FatbinHandle> {
...
pub unsafe fn launch_kernel(
    ...
    if args.is_null() && !prog.params.is_empty() {
        ...
        return Err(GpuError::Invalid("cudaLaunchKernel: null args for a kernel with parameters"));
    }
